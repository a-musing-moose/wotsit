 ...
 * @subpackage storage
 */
class wotsit_storage_TestPersistentMemory extends PHPUnit_Extensions_Story_TestCase
{
	...
	public function runGiven(&$world, $action, $arguments)
    {
        ...
        switch ($action) {
            case 'a new store':
                if (isset($world['store'])) {
                    unset($world['store']);
                }
                @unlink($this->filePath);
                $world['store'] = new wotsit_storage_PersistentMemory($this->filePath);
                break;
            default:
    ...
    {
        if (isset($this->world['store'])) {
            unset($this->world['store']);
        }
        @unlink($this->filePath);
    }
